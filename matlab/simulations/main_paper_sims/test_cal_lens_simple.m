...
figure;
yyaxis left
semilogx(cal_lens, SNDRs_cases, '*','MarkerSize',12, 'Color',[0 0 1]);
hold on
semilogx(cal_lens, SNDRs_cases_max, '*','MarkerSize',12,'Color',[0.7 0 1 0.3]);
...
title('SNDR and convergency time for each cal length','Color','black');
